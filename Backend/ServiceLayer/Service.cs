...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    public class Service
    {
        ...
        public Response LoadData()  //data loading order: Users -> Boards -> BoardMembers -> Tasks -> User Boards
        {
        ...
        {
            return US.Register(userEmail, password);
        }
        /// <summary>
        ...
        {
            return US.Login(userEmail, password);
        }
        /// <summary>        
        ...
        {
            return BS.LimitColumn(userEmail, creatorEmail, boardName, columnOrdinal, limit);
        }
        ...
        {
            return BS.GetColumnLimit(userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return BS.GetColumnName(userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return BS.AddTask(userEmail, creatorEmail, boardName, title, description, dueDate);
        }
        /// <summary>
        ...
        {
            return BS.UpdateTaskDueDate(userEmail, creatorEmail, boardName, columnOrdinal, taskId, dueDate);
        }
        /// <summary>
        /// Update task title
        /// </summary>
        ...
        {
            return BS.UpdateTaskTitle(userEmail, creatorEmail, boardName, columnOrdinal, taskId, title);
        }
        /// <summary>
        ...
        {
            return BS.UpdateTaskDescription(userEmail, creatorEmail, boardName, columnOrdinal, taskId, description);
        }
        /// <summary>
        ...
        {
            return BS.AdvanceTask(userEmail, creatorEmail, boardName, columnOrdinal, taskId);
        }
        /// <summary>
        ...
        {
            return BS.GetColumn(userEmail, creatorEmail, boardName, columnOrdinal);
        }
        /// <summary>
        ...
        {
            return BS.AddBoard(userEmail, boardName);
        }
        /// <summary>
        /// Removes a board.
        /// </summary>
        ...
        {
            return BS.RemoveBoard(userEmail, creatorEmail, boardName);
        }
        /// <summary>
        ...
        {
            return BS.JoinBoard(userEmail, creatorEmail, boardName);
        }
        /// <summary>
        ...
        {
            return BS.InProgressTasks(userEmail);
        }
        /// <summary>
        ...
        {
            return BS.AssignTask(userEmail, creatorEmail, boardName, columnOrdinal, taskId, assigneeEmail);
        }
        ...
        {
            return US.GetBoardNames(userEmail);
        }
        ...
        {
            return BS.AddColumn(userEmail, creatorEmail, boardName, columnOrdinal, columnName);
        }
        ...
        {
            return BS.RemoveColumn(userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return BS.RenameColumn(userEmail, creatorEmail, boardName, columnOrdinal, newColumnName);
        }
